...
.VERSION 0.0.1
.AUTHOR Jimmy Briggs
.COPYRIGHT (c) Jimmy Briggs
.TAGS Markdown README Index TOC Automation
.GUID {749f233f-a4a1-4a7d-9182-52a83c34a59e}
.LICENSEURI https://github.com/jimbrig/PSXLDevTools/blob/main/LICENSE
...
# Gets markdown list lines with links to folders/files recursively.
